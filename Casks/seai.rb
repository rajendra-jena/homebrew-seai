cask "seai" do
  ...
  on_arm do
    url "https://github.com/rajendra-jena/seai/releases/download/v#{version}/se.AI.By.Infosys-darwin-arm64-#{version}.zip"
    sha256 "9c9b577ac96ae59bb10ce00a861276f6849d119cce835af6428280625b479401"
  end

  on_intel do
    url "https://github.com/rajendra-jena/seai/releases/download/v#{version}/se.AI.By.Infosys-darwin-x64-#{version}.zip"
    sha256 "REPLACE_WITH_X64_SHA256"
  end

  name "se.AI By Infosys"
  desc "AI agent for software engineering tasks"
  homepage "https://github.com/rajendra-jena/seai/"
